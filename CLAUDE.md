...
| Current shipping version | `1.5 (build 14)` (Sep 2026) — straight-set strength + honest program catalog, inline PR detection and crash-recovery fixes, rep-cap clear persistence, Share-toggle removal. Build 13 (Aug 2026) was the first with the hero-ring logger, v1 scope-down, progression rewrite, Rep Sheet, and target-adherence Progress tab |
