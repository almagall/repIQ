    ...
    static let phul = ProgramDefinition(
        ...
        days: [
            ProgramDayDefinition(
                ...
                exercises: [
                    ProgramExerciseDefinition(exerciseName: "Barbell Bench Press", trainingMode: .strength, setScheme: .straight, targetSets: 4, restSecondsOverride: 180),
                    ProgramExerciseDefinition(exerciseName: "Barbell Row", trainingMode: .strength, setScheme: .straight, targetSets: 4, restSecondsOverride: 180),
                    ProgramExerciseDefinition(exerciseName: "Overhead Press", trainingMode: .strength, setScheme: .straight, targetSets: 3, restSecondsOverride: 120),
                    ProgramExerciseDefinition(exerciseName: "Lat Pulldown", trainingMode: .strength, setScheme: .straight, targetSets: 3, restSecondsOverride: 120),
            ...
            ProgramDayDefinition(
                ...
                exercises: [
                    ProgramExerciseDefinition(exerciseName: "Barbell Squat", trainingMode: .strength, setScheme: .straight, targetSets: 4, restSecondsOverride: 300),
                    ProgramExerciseDefinition(exerciseName: "Deadlift", trainingMode: .strength, setScheme: .straight, targetSets: 3, restSecondsOverride: 300),
                    ProgramExerciseDefinition(exerciseName: "Leg Press", trainingMode: .strength, setScheme: .straight, targetSets: 4, restSecondsOverride: 120),
    ...
    static let phat = ProgramDefinition(
        ...
        days: [
            ProgramDayDefinition(
                ...
                exercises: [
                    ProgramExerciseDefinition(exerciseName: "Barbell Row", trainingMode: .strength, setScheme: .straight, targetSets: 4, restSecondsOverride: 180),
                    ProgramExerciseDefinition(exerciseName: "Pull-Ups", trainingMode: .strength, setScheme: .straight, targetSets: 3, restSecondsOverride: 120),
                    ProgramExerciseDefinition(exerciseName: "Rack Pull", trainingMode: .strength, setScheme: .straight, targetSets: 3, restSecondsOverride: 180),
                    ProgramExerciseDefinition(exerciseName: "Barbell Bench Press", trainingMode: .strength, setScheme: .straight, targetSets: 4, restSecondsOverride: 180),
                    ProgramExerciseDefinition(exerciseName: "Dumbbell Shoulder Press", trainingMode: .strength, setScheme: .straight, targetSets: 3, restSecondsOverride: 120),
                    ProgramExerciseDefinition(exerciseName: "Barbell Curl", trainingMode: .hypertrophy, targetSets: 3),
                    ProgramExerciseDefinition(exerciseName: "Skull Crushers", trainingMode: .hypertrophy, targetSets: 3),
                ]),
            ProgramDayDefinition(
                ...
                exercises: [
                    ProgramExerciseDefinition(exerciseName: "Barbell Squat", trainingMode: .strength, setScheme: .straight, targetSets: 4, restSecondsOverride: 300),
                    ProgramExerciseDefinition(exerciseName: "Hack Squat", trainingMode: .strength, setScheme: .straight, targetSets: 3, restSecondsOverride: 120),
                    ProgramExerciseDefinition(exerciseName: "Leg Press", trainingMode: .strength, setScheme: .straight, targetSets: 3, restSecondsOverride: 120),
                    ProgramExerciseDefinition(exerciseName: "Stiff-Leg Deadlift", trainingMode: .strength, setScheme: .straight, targetSets: 3, restSecondsOverride: 120),
                    ProgramExerciseDefinition(exerciseName: "Leg Curls", trainingMode: .hypertrophy, targetSets: 3),
    ...
    static let redditPPL = ProgramDefinition(
        ...
        days: [
            ProgramDayDefinition(
                ...
                exercises: [
                    ProgramExerciseDefinition(exerciseName: "Barbell Bench Press", trainingMode: .strength, setScheme: .straight, targetSets: 5, restSecondsOverride: 180, notes: "5x5 — same weight every set, weight goes up once you get all 25"),
            ...
            ProgramDayDefinition(
                ...
                exercises: [
                    ProgramExerciseDefinition(exerciseName: "Deadlift", trainingMode: .strength, setScheme: .straight, targetSets: 1, restSecondsOverride: 180, notes: "One heavy set of 5 — warm up to it first"),
            ...
            ProgramDayDefinition(
                ...
                exercises: [
                    ProgramExerciseDefinition(exerciseName: "Overhead Press", trainingMode: .strength, setScheme: .straight, targetSets: 5, restSecondsOverride: 180, notes: "5x5 — same weight every set, weight goes up once you get all 25"),
            ...
            ProgramDayDefinition(
                ...
                exercises: [
                    ProgramExerciseDefinition(exerciseName: "Barbell Row", trainingMode: .strength, setScheme: .straight, targetSets: 5, restSecondsOverride: 180, notes: "5x5 — same weight every set, weight goes up once you get all 25"),
            ...
            ProgramDayDefinition(
                ...
                exercises: [
                    ProgramExerciseDefinition(exerciseName: "Front Squat", trainingMode: .strength, setScheme: .straight, targetSets: 3, restSecondsOverride: 180, notes: "Straight 5s — get every rep and the weight goes up next session"),
                    ProgramExerciseDefinition(exerciseName: "Bulgarian Split Squat", trainingMode: .hypertrophy, targetSets: 3),
                    ProgramExerciseDefinition(exerciseName: "Leg Press", trainingMode: .hypertrophy, targetSets: 3),
                    ProgramExerciseDefinition(exerciseName: "Leg Extensions", trainingMode: .hypertrophy, targetSets: 3),
                    ProgramExerciseDefinition(exerciseName: "Leg Curls", trainingMode: .hypertrophy, targetSets: 3),
